...
public class PersonnelOffice
{
	...
	public void report()
	{
		...
		{
			System.out.println(allEmployees.get(i).toStringSalaryDetails()); //Call the toStringSalaryDetails methods of employees/managers
			total += allEmployees.get(i).getSalary();
		}
