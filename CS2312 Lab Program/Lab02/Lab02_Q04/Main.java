...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException //We will learn exceptions later
	{
		...
		//
		tableObj.print();
		System.out.print("Maximum row sum: " + tableObj.getRowSumMax());		
		tableObj.printAllRowsOfMax();
		System.out.print("Maximum col sum: " + tableObj.getColSumMax());
		tableObj.printAllColsOfMax();
		scannerObj.close();
	}
